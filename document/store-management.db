...
(
    ...
    REFER_PRICE          DECIMAL(13, 4),
    QUANTITY             INT,
    BILLING              BOOL,
    TRANSACTION_ID       VARCHAR(50),
    CONSTRAINT PK_SALE_UNIT PRIMARY KEY (ID),
    CONSTRAINT FK_SALE_UNIT_TRANSACTION FOREIGN KEY (TRANSACTION_ID) REFERENCES TRANSACTION (ID),
    CONSTRAINT FK_SALE_UNIT_PRICE_FLUCTUATION FOREIGN KEY (PRICE_FLUCTUATION_ID) REFERENCES PRICE_FLUCTUATION (ID)
...
(
    ...
    QUANTITY       INT,
    IMPORT_PRICE   DECIMAL(13, 4),
    TRANSACTION_ID VARCHAR(50),
    CONSTRAINT PK_IMPORT_UNIT PRIMARY KEY (ID),
    CONSTRAINT FK_IMPORT_UNIT_PRODUCT FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT (ID),
    CONSTRAINT FK_IMPORT_UNIT_TRANSACTION FOREIGN KEY (TRANSACTION_ID) REFERENCES TRANSACTION (ID)
);
